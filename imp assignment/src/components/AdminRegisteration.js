...
<Box sx={{backgroundColor: '#E5E4E2',width: "1349px",height: "1099px",position:"absolute"}}>
<Box sx={{marginTop:"28px"}}>
  <Typography variant="h2" sx={{textAlign:"center",fontFamily: '"Times New Roman", Times, serif',fontWeight:"bold",color:"#0047AB"}}>Admin Regitrartion Form</Typography>
</Box>
<Box sx={{borderLeft:"18px solid #0047AB",marginLeft:"200px",borderRadius:"20px",marginTop:"40px",backgroundColor: 'white',height:"910px",width:"1000px"}}>
